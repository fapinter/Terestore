...
public class SupplierDAO {
    ...
    public void updateSupplierCnpj(String newCnpj, String cnpj) {
        String query = "UPDATE supplier SET cnpj = ? WHERE cnpj = ?";
    ...
    public void updateSupplierCompanyName(String newCompName, String cnpj) {
        String query = "UPDATE supplier SET company_name = ? WHERE cnpj = ?";
        PreparedStatement ps = null;

        try {
            ps = conexao.getConnection().prepareStatement(query);
            ps.setString(1,newCompName );
            ps.setString(2, cnpj);
            ps.executeUpdate();
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    public void updateSupplierNamePerson(String newNamePer, String cnpj) {
        String query = "UPDATE supplier SET name_person = ? WHERE cnpj = ?";
        PreparedStatement ps = null;

        try {
            ps = conexao.getConnection().prepareStatement(query);
            ps.setString(1,newNamePer );
            ps.setString(2, cnpj);
            ps.executeUpdate();
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    public void updateSupplierEmail(String newSupEmail, String cnpj) {
        String query = "UPDATE supplier SET email = ? WHERE cnpj = ?";
        PreparedStatement ps = null;

        try {
            ps = conexao.getConnection().prepareStatement(query);
            ps.setString(1,newSupEmail );
            ps.setString(2, cnpj);
            ps.executeUpdate();
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    public void updateSupplierPasswordEmail(String newPasswordEmail, String cnpj) {
        String query = "UPDATE supplier SET password_email = ? WHERE cnpj = ?";
        PreparedStatement ps = null;

        try {
            ps = conexao.getConnection().prepareStatement(query);
            ps.setString(1,newPasswordEmail );
            ps.setString(2, cnpj);
            ps.executeUpdate();
        } catch (SQLException ex) {
            ex.printStackTrace();
    ...
    public void updateSupplierPhoneNum(String newPhoneNum, String cnpj) {
        String query = "UPDATE supplier SET phone_number = ? WHERE cnpj = ?";
        PreparedStatement ps = null;
    ...
    public void updateSupplierCity(String newCity, String cnpj) {
        String query = "UPDATE supplier SET city = ? WHERE cnpj = ?";
        PreparedStatement ps = null;
    ...
    public void updateSupplierState(String newState, String cnpj) {
        String query = "UPDATE supplier SET state = ? WHERE cnpj = ?";
        PreparedStatement ps = null;
    ...
    public void updateSupplierCountry(String newCountry, String cnpj) {
        String query = "UPDATE supplier SET country = ? WHERE cnpj = ?";
        PreparedStatement ps = null;
    ...
    public void updateSupplierAddress(String newAddress, String cnpj) {
        String query = "UPDATE supplier SET address = ? WHERE cnpj = ?";
        PreparedStatement ps = null;
    ...
    public void updateSupplierNumberAddress(int newAddressNum, String cnpj) {
        String query = "UPDATE supplier SET number_address = ? WHERE cnpj = ?";
        PreparedStatement ps = null;

        try {
            ps = conexao.getConnection().prepareStatement(query);
            ps.setInt(1,newAddressNum );
            ps.setString(2, cnpj);
            ps.executeUpdate();
        } catch (SQLException ex) {
            ex.printStackTrace();
